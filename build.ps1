...
if ($Export) {
    Write-Host "Package Succeeded! Output: bin\Abyss.iq" -ForegroundColor Green
} else {
    Write-Host "Build Succeeded! Output: bin\Abyss.prg" -ForegroundColor Green
}
